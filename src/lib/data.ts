...
export const BREADS: Ingredient[] = [
  { id: 'white-toast', name: '白吐司', category: 'bread', icon: Wheat, price: 10.00, image: 'https://placehold.co/100x67.png', dataAiHint: 'white toast'},
  { id: 'thick-cut-toast', name: '厚片吐司', category: 'bread', icon: Wheat, price: 15.00, image: 'https://placehold.co/100x67.png', dataAiHint: 'thick cut toast' },
  { id: 'whole-wheat-toast', name: '全麥吐司', category: 'bread', icon: Wheat, price: 12.00, image: 'https://placehold.co/100x67.png', dataAiHint: 'whole wheat toast' },
  { id: 'wheat-germ-toast', name: '胚芽吐司', category: 'bread', icon: Wheat, price: 13.00, image: 'https://placehold.co/100x67.png', dataAiHint: 'wheat germ toast' },
  { id: 'rye-toast', name: '裸麥吐司', category: 'bread', icon: Wheat, price: 15.00, image: 'https://placehold.co/100x67.png', dataAiHint: 'rye toast' },
];

export const MEATS: Ingredient[] = [
  // Fish
  { id: 'tuna', name: '鮪魚', category: 'meat', icon: Fish, price: 15.00, image: 'https://placehold.co/80x53.png', dataAiHint: 'tuna fish' },
  { id: 'smoked-salmon', name: '煙燻鮭魚', category: 'meat', icon: Fish, price: 35.00, image: 'https://placehold.co/80x53.png', dataAiHint: 'smoked salmon' },
  // Chicken
  { id: 'lemon-chicken', name: '檸檬雞', category: 'meat', icon: Drumstick, price: 15.00, image: 'https://placehold.co/80x53.png', dataAiHint: 'lemon chicken' },
  { id: 'smoked-chicken', name: '燻雞', category: 'meat', icon: Drumstick, price: 15.00, image: 'https://placehold.co/80x53.png', dataAiHint: 'smoked chicken' },
  { id: 'teriyaki-chicken', name: '照燒雞', category: 'meat', icon: Drumstick, price: 15.00, image: 'https://placehold.co/80x53.png', dataAiHint: 'teriyaki chicken' },
  { id: 'black-pepper-chicken', name: '黑胡椒雞', category: 'meat', icon: Drumstick, price: 15.00, image: 'https://placehold.co/80x53.png', dataAiHint: 'pepper chicken' },
  { id: 'fried-chicken', name: '卡拉雞', category: 'meat', icon: Flame, price: 20.00, image: 'https://placehold.co/80x53.png', dataAiHint: 'fried chicken' },
  // Pork
  { id: 'meat-slices', name: '肉片', category: 'meat', icon: Beef, price: 15.00, image: 'https://placehold.co/80x53.png', dataAiHint: 'meat slices' },
  { id: 'roasted-pork', name: '燒肉', category: 'meat', icon: Beef, price: 15.00, image: 'https://placehold.co/80x53.png', dataAiHint: 'roasted pork' },
  { id: 'black-pepper-pork', name: '黑胡椒豬', category: 'meat', icon: Beef, price: 15.00, image: 'https://placehold.co/80x53.png', dataAiHint: 'pepper pork' },
  { id: 'korean-bbq-meat', name: '韓式烤肉', category: 'meat', icon: Flame, price: 18.00, image: 'https://placehold.co/80x53.png', dataAiHint: 'korean bbq' },
  // Beef
  { id: 'beef-slices', name: '牛肉片', category: 'meat', icon: Beef, price: 18.00, image: 'https://placehold.co/80x53.png', dataAiHint: 'beef slices' },
  // Sausages / Processed
  { id: 'german-sausage', name: '德式香腸', category: 'meat', icon: Beef, price: 15.00, image: 'https://placehold.co/80x53.png', dataAiHint: 'german sausage' },
  { id: 'italian-salami', name: '義式臘腸', category: 'meat', icon: Beef, price: 15.00, image: 'https://placehold.co/80x53.png', dataAiHint: 'salami pepperoni' },
  // Specially Priced
  { id: 'ham', name: '火腿', category: 'meat', icon: Beef, price: 10.00, image: 'https://placehold.co/80x53.png', dataAiHint: 'sliced ham' },
  { id: 'bacon', name: '培根', category: 'meat', icon: Beef, price: 12.00, image: 'https://placehold.co/80x53.png', dataAiHint: 'crispy bacon' },
  { id: 'pork-floss', name: '肉鬆', category: 'meat', icon: Beef, price: 12.00, image: 'https://placehold.co/80x53.png', dataAiHint: 'pork floss' },
];
...
export const SAUCES: Ingredient[] = [
  // Sweet Sauces
  { id: 'chocolate', name: '巧克力醬', category: 'sauce', icon: Droplets, price: 10.00, image: 'https://placehold.co/60x40.png', dataAiHint: 'chocolate sauce' },
  { id: 'strawberry-jam', name: '草莓醬', category: 'sauce', icon: Apple, price: 10.00, image: 'https://placehold.co/60x40.png', dataAiHint: 'strawberry jam' },
  { id: 'blueberry-jam', name: '藍莓醬', category: 'sauce', icon: Grape, price: 10.00, image: 'https://placehold.co/60x40.png', dataAiHint: 'blueberry jam' },
  { id: 'orange-jam', name: '柳橙醬', category: 'sauce', icon: Citrus, price: 10.00, image: 'https://placehold.co/60x40.png', dataAiHint: 'orange jam' },
  { id: 'peanut-butter', name: '花生醬', category: 'sauce', icon: Nut, price: 10.00, image: 'https://placehold.co/60x40.png', dataAiHint: 'peanut butter' },
  { id: 'milk-crisp', name: '奶酥', category: 'sauce', icon: Cookie, price: 15.00, image: 'https://placehold.co/60x40.png', dataAiHint: 'milk crisp spread' },
  { id: 'matcha', name: '抹茶醬', category: 'sauce', icon: Leaf, price: 15.00, image: 'https://placehold.co/60x40.png', dataAiHint: 'matcha sauce' },
  { id: 'honey', name: '蜂蜜', category: 'sauce', icon: Droplets, price: 15.00, image: 'https://placehold.co/60x40.png', dataAiHint: 'honey' },
  { id: 'maple-syrup', name: '楓糖醬', category: 'sauce', icon: Droplets, price: 15.00, image: 'https://placehold.co/60x40.png', dataAiHint: 'maple syrup' },
  { id: 'caramel', name: '焦糖醬', category: 'sauce', icon: Droplets, price: 15.00, image: 'https://placehold.co/60x40.png', dataAiHint: 'caramel sauce' },
  { id: 'lemon-curd', name: '檸檬醬', category: 'sauce', icon: Citrus, price: 12.00, image: 'https://placehold.co/60x40.png', dataAiHint: 'lemon curd' },
  // Savory Sauces
  { id: 'garlic', name: '蒜（蒜泥）', category: 'sauce', icon: Droplets, price: 5.00, image: 'https://placehold.co/60x40.png', dataAiHint: 'garlic paste sauce' },
  { id: 'roasted-garlic', name: '香蒜醬（熟蒜泥風味）', category: 'sauce', icon: Droplets, price: 10.00, image: 'https://placehold.co/60x40.png', dataAiHint: 'roasted garlic sauce' },
  { id: 'pepper-sauce', name: '胡椒醬', category: 'sauce', icon: Sparkles, price: 5.00, image: 'https://placehold.co/60x40.png', dataAiHint: 'pepper sauce' },
  { id: 'honey-mustard', name: '蜂蜜芥末醬', category: 'sauce', icon: Droplets, price: 10.00, image: 'https://placehold.co/60x40.png', dataAiHint: 'honey mustard sauce' },
  { id: 'thousand-island', name: '千島醬', category: 'sauce', icon: Droplets, price: 10.00, image: 'https://placehold.co/60x40.png', dataAiHint: 'thousand island sauce' },
  { id: 'caesar', name: '凱薩醬', category: 'sauce', icon: Droplets, price: 10.00, image: 'https://placehold.co/60x40.png', dataAiHint: 'caesar dressing' },
  { id: 'cheese-sauce', name: '起司醬', category: 'sauce', icon: Droplets, price: 15.00, image: 'https://placehold.co/60x40.png', dataAiHint: 'cheese sauce' },
  { id: 'chili-sauce', name: '辣椒醬', category: 'sauce', icon: Flame, price: 5.00, image: 'https://placehold.co/60x40.png', dataAiHint: 'chili sauce' },
  { id: 'mayo', name: '美乃滋', category: 'sauce', icon: Droplets, price: 5.00, image: 'https://placehold.co/60x40.png', dataAiHint: 'mayonnaise sauce' },
  { id: 'mustard', name: '黃芥末醬', category: 'sauce', icon: Droplets, price: 5.00, image: 'https://placehold.co/60x40.png', dataAiHint: 'mustard sauce' },
  { id: 'hollandaise', name: '荷蘭醬', category: 'sauce', icon: EggFried, price: 10.00, image: 'https://placehold.co/60x40.png', dataAiHint: 'hollandaise sauce' },
  { id: 'pesto', name: '青醬', category: 'sauce', icon: Leaf, price: 8.00, image: 'https://placehold.co/60x40.png', dataAiHint: 'pesto sauce' },
  { id: 'ketchup', name: '番茄醬', category: 'sauce', icon: Apple, price: 5.00, image: 'https://placehold.co/60x40.png', dataAiHint: 'ketchup sauce' },
  { id: 'sesame-paste', name: '芝麻醬', category: 'sauce', icon: Sprout, price: 15.00, image: 'https://placehold.co/60x40.png', dataAiHint: 'sesame paste sauce' },
];

// Reorganized TOPPINGS
export const TOPPINGS: Ingredient[] = [
  // Fruits
  { id: 'strawberry', name: '新鮮草莓', category: 'topping', icon: Apple, price: 20.00, image: 'https://placehold.co/70x47.png', dataAiHint: 'fresh strawberries' },
  { id: 'avocado', name: '酪梨', category: 'topping', icon: Leaf, price: 25.00, image: 'https://placehold.co/70x47.png', dataAiHint: 'avocado' },
  { id: 'banana-slices', name: '香蕉片', category: 'topping', icon: Apple, price: 15.00, image: 'https://placehold.co/70x47.png', dataAiHint: 'banana slices' },
  { id: 'kiwi', name: '奇異果', category: 'topping', icon: Apple, price: 20.00, image: 'https://placehold.co/70x47.png', dataAiHint: 'kiwi slices' },
  { id: 'mango-cubes', name: '芒果丁', category: 'topping', icon: Apple, price: 25.00, image: 'https://placehold.co/70x47.png', dataAiHint: 'mango cubes' },
  { id: 'pineapple-slices', name: '鳳梨片', category: 'topping', icon: Apple, price: 15.00, image: 'https://placehold.co/70x47.png', dataAiHint: 'pineapple slices' },
  { id: 'apple-slices', name: '蘋果片', category: 'topping', icon: Apple, price: 15.00, image: 'https://placehold.co/70x47.png', dataAiHint: 'apple slices' },
  { id: 'blueberry', name: '藍莓', category: 'topping', icon: Grape, price: 20.00, image: 'https://placehold.co/70x47.png', dataAiHint: 'blueberries' },
  { id: 'cherry-tomatoes', name: '小番茄', category: 'topping', icon: Apple, price: 15.00, image: 'https://placehold.co/70x47.png', dataAiHint: 'cherry tomatoes' },
  // Cheese
  { id: 'cheese-slice', name: '起司片', category: 'topping', icon: Cookie, price: 10.00, image: 'https://placehold.co/70x47.png', dataAiHint: 'cheese slice' },
  { id: 'shredded-cheese', name: '乳酪絲', category: 'topping', icon: Cookie, price: 10.00, image: 'https://placehold.co/70x47.png', dataAiHint: 'shredded cheese' },
  // Sweet/Dessert Toppings
  { id: 'marshmallows', name: '棉花糖', category: 'topping', icon: IceCream, price: 5.00, image: 'https://placehold.co/70x47.png', dataAiHint: 'marshmallows' },
  { id: 'chocolate-chips', name: '巧克力片', category: 'topping', icon: Cookie, price: 15.00, image: 'https://placehold.co/70x47.png', dataAiHint: 'chocolate chips' },
  { id: 'colorful-chocolate-beans', name: '彩色巧克力豆', category: 'topping', icon: Sparkles, price: 12.00, image: 'https://placehold.co/70x47.png', dataAiHint: 'colorful chocolate beans' },
  { id: 'oreo-crumbs', name: '奧利奧餅乾碎', category: 'topping', icon: Cookie, price: 15.00, image: 'https://placehold.co/70x47.png', dataAiHint: 'oreo cookie crumbs' },
  { id: 'coconut-flakes', name: '椰子絲', category: 'topping', icon: Sprout, price: 15.00, image: 'https://placehold.co/70x47.png', dataAiHint: 'coconut flakes' },
  // Savory/Vegetable/Other Toppings
  { id: 'corn', name: '玉米', category: 'topping', icon: Sparkles, price: 5.00, image: 'https://placehold.co/70x47.png', dataAiHint: 'corn kernels' },
  { id: 'hashbrown', name: '薯餅', category: 'topping', icon: Flame, price: 15.00, image: 'https://placehold.co/70x47.png', dataAiHint: 'hash brown' },
  { id: 'hotdog-egg', name: '熱狗蛋', category: 'topping', icon: EggFried, price: 20.00, image: 'https://placehold.co/70x47.png', dataAiHint: 'hot dog egg' },
  { id: 'egg', name: '煎蛋', category: 'topping', icon: EggFried, price: 10.00, image: 'https://placehold.co/70x47.png', dataAiHint: 'fried egg' },
  { id: 'mixed-nuts', name: '堅果碎（綜合）', category: 'topping', icon: Nut, price: 20.00, image: 'https://placehold.co/70x47.png', dataAiHint: 'mixed nuts' },
  { id: 'almond-slices', name: '杏仁片', category: 'topping', icon: Nut, price: 18.00, image: 'https://placehold.co/70x47.png', dataAiHint: 'almond slices' },
  { id: 'walnut-pieces', name: '核桃碎', category: 'topping', icon: Nut, price: 20.00, image: 'https://placehold.co/70x47.png', dataAiHint: 'walnut pieces' },
  { id: 'peanut-pieces', name: '花生碎', category: 'topping', icon: Nut, price: 12.00, image: 'https://placehold.co/70x47.png', dataAiHint: 'peanut pieces' },
  { id: 'oatmeal', name: '燕麥片', category: 'topping', icon: Wheat, price: 10.00, image: 'https://placehold.co/70x47.png', dataAiHint: 'oatmeal flakes' },
  { id: 'cucumber-slices', name: '小黃瓜片', category: 'topping', icon: Leaf, price: 10.00, image: 'https://placehold.co/70x47.png', dataAiHint: 'cucumber slices' },
  { id: 'onion-rings', name: '洋蔥圈', category: 'topping', icon: Carrot, price: 10.00, image: 'https://placehold.co/70x47.png', dataAiHint: 'onion rings' },
  { id: 'green-pepper-strips', name: '青椒絲', category: 'topping', icon: Leaf, price: 10.00, image: 'https://placehold.co/70x47.png', dataAiHint: 'green pepper strips' },
  { id: 'shredded-lettuce', name: '生菜絲', category: 'topping', icon: LeafyGreen, price: 8.00, image: 'https://placehold.co/70x47.png', dataAiHint: 'shredded lettuce' },
  { id: 'shredded-purple-cabbage', name: '紫高麗菜絲', category: 'topping', icon: LeafyGreen, price: 10.00, image: 'https://placehold.co/70x47.png', dataAiHint: 'shredded purple cabbage' },
  { id: 'shredded-carrot', name: '胡蘿蔔絲', category: 'topping', icon: Carrot, price: 8.00, image: 'https://placehold.co/70x47.png', dataAiHint: 'shredded carrot' },
];
